  ...
  SubwayDto.fromJson(dynamic json) {
    ...
    if (json['realtimeArrivalList'] != null) {
      ...
      json['realtimeArrivalList'].forEach((v) {
        realtimeArrivalList?.add(RealtimeArrivalListDto.fromJson(v));
      });
    }
  }
  ErrorMessage? errorMessage;
  List<RealtimeArrivalListDto>? realtimeArrivalList;
...
class RealtimeArrivalListDto {
  RealtimeArrivalListDto({
    this.beginRow,
    this.endRow,
    this.curPage,
    this.pageRow,
  ...
  RealtimeArrivalListDto.fromJson(dynamic json) {
